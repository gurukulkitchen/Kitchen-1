                                    ...
                                    <div className="flex flex-row items-center justify-between gap-4 py-4 px-6 bg-[#E5E5E5] dark:bg-[#181818]">
                                        ...
                                        <div className="flex items-center gap-5 shrink-0">
                                            ...
                                            <button
                                                ...
                                                className="flex flex-col items-center justify-center gap-0.5 group transition-all cursor-pointer"
                                            >
                                                <div className="w-6 h-6 rounded-full border-2 border-[#882619] text-[#882619] flex items-center justify-center font-black text-xs">
                                                    +
                                                </div>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="w-3/5 p-[1.5px] bg-gradient-to-r from-[#882619] to-[#D4612D] rounded-xl shadow-xs">
                                                        <input
                                                            ...
                                                            placeholder="Name"
                                                            required
                                                            className="w-full px-3.5 py-1.5 bg-white dark:bg-[#252525] rounded-[10.5px] text-xs text-stone-800 dark:text-stone-200 outline-none placeholder:text-stone-300 dark:placeholder:text-stone-600"
                                                        />
                                                    </div>
                                                </div>
